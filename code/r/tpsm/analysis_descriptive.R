...
OUTPUT_DIR <- if (length(args) >= 1) args[1] else "outputs/active/r/analysis"
DATA_PATH <- if (length(args) >= 2) args[2] else "outputs/active/r/combined_pairwise_differences.csv"
