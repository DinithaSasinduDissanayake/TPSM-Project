    ...
    tasks = list(
      list(
        ...
        datasets = list(
          ...
          list(id = "avila", source = "uci", path = "data/classification/avila.csv", url = "https://archive.ics.uci.edu/ml/machine-learning-databases/00459/Avila.zip", target = "class", zip_file = "avila-tr.txt", force_binary = FALSE)
        ),
        model_pairs = list(
      ...
      list(
        ...
        datasets = list(
          ...
          list(id = "concrete_strength", source = "uci", path = "data/regression/concrete_strength.csv", url = "https://archive.ics.uci.edu/ml/machine-learning-databases/concrete/compressive/Concrete_Data.xls", target = "Strength"),
      ...
      list(
        ...
        datasets = list(
          ...
          list(id = "household_power", source = "uci", path = "data/timeseries/household_power.csv", url = "https://archive.ics.uci.edu/ml/machine-learning-databases/00235/household_power_consumption.zip", target = "Global_active_power", time_col = "Date", exog_cols = c("Global_reactive_power", "Voltage"), na_strings = "?", max_rows = 50000)
        ),
        model_pairs = list(
