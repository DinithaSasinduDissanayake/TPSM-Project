    ...
    tasks = list(
      list(
        ...
        datasets = list(
          ...
          list(id = "avila", source = "uci", path = "data/classification/avila.csv", url = "https://archive.ics.uci.edu/ml/machine-learning-databases/00459/Avila.zip", target = "F10", zip_file = "avila-tr.txt", force_binary = FALSE)
        ),
        model_pairs = list(
